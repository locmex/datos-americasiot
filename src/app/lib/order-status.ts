...
export const ORDER_STATUS: Record<OrderStatus, OrderStatusConfig> = {
  pending:   { label: "Pendiente",  color: "#6b7280", bg: "rgba(107,114,128,0.12)", icon: Clock },
  preparing: { label: "Preparando", color: "#d97706", bg: "rgba(217,119,6,0.12)",   icon: PackageCheck },
  shipped:   { label: "Enviado",    color: "#3b82f6", bg: "rgba(59,130,246,0.12)",  icon: Truck },
  delivered: { label: "Recibido",   color: "#16a34a", bg: "rgba(22,163,74,0.12)",   icon: CheckCircle2 },
  cancelled: { label: "Cancelado",  color: "#dc2626", bg: "rgba(220,38,38,0.12)",   icon: XCircle },
};
